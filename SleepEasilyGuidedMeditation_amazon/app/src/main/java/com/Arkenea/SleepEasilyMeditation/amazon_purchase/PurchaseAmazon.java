...
public class PurchaseAmazon {
    ...
    //public static String ITEM_SKU_FIRST = "";
   // public static String ITEM_SKU_SECOND = "";
   // public static String ITEM_SKU_THIRD = "";
    
    public PurchaseAmazon(Activity activity, PurchaseStatus listner){
        mActivity= activity;
    ...
    private void setupIAPOnCreate() {
        sampleIapManager = new SampleIapManager(mActivity,listner);
        final SamplePurchasingListener purchasingListener = new SamplePurchasingListener(sampleIapManager,listner);
        Log.d(TAG, "onCreate: registering PurchasingListener");
        PurchasingService.registerListener(mActivity.getApplicationContext(), purchasingListener);
    ...
    public void setLevel2Availbility(final boolean productAvailable, final boolean userAlreadyPurchased) {
        Log.e("product", ".."+productAvailable+";"+userAlreadyPurchased);
        if (productAvailable) {
