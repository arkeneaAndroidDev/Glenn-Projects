...
public class SplashScreen extends Activity {
    ...
    private final static String APP_PKGNAME = "com.Arkenea.SleepEasilyMeditatation";// Package Name
    ...
    public  void showReviewDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        mReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mContext.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("amzn://apps/android?p=com.Arkenea.SleepEasilyMeditatation")));
                dialog.dismiss();
            }
        });
