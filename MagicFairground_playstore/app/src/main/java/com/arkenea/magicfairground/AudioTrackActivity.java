...
//        Log.d("MeditationPreference***",""+MeditationPreference.getInt("audio" + 1, 0));
     //   Log.d("MeditationPreference***",""+MeditationPreference.getInt("audio" + 2, 0));
        ...
        if (MeditationPreference.getString("DATA", "NO_DATA").trim().equalsIgnoreCase("NO_DATA") || MeditationPreference.getString("DATA", "NO_DATA").trim().equalsIgnoreCase("") ) {
        ...
        Lp.topMargin = (int) Math.round(height * 0.30);
            ...
            try {
                ...
                purchase_history_list_item_container.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        int permission  = ContextCompat.checkSelfPermission(AudioTrackActivity.this,
                                Manifest.permission.WRITE_EXTERNAL_STORAGE);
                        if (permission == PackageManager.PERMISSION_GRANTED) {
                           test(selectedPosition);
                        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                            && ContextCompat.checkSelfPermission(AudioTrackActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(AudioTrackActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                100);
    ...
    { Log.d("MeditationPreference***",""+MeditationPreference.getInt("audio" + position, 0));
        if (position != 0) {
        ...
        if (MeditationPreference.getInt("audio" + position, 0) == 0) {
            ...
            download_txt.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   /* int permission  = ContextCompat.checkSelfPermission(AudioTrackActivity.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE);
                    if (permission == PackageManager.PERMISSION_GRANTED && !folder.exists()) {*/
