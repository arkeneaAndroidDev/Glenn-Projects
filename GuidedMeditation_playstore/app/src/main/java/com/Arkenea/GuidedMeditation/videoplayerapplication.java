...
public class videoplayerapplication extends Application /*implements Runnable*/ {
	...
	public void onCreate() {
		...
		super.onCreate();
		//activity=new audioplayerActivity();
	}
	...
	{
		//mp=new MediaPlayer();
		Log.v("inside", "application");

		if(checkaudio==1)
		{
		//	mp=MediaPlayer.create(this, R.raw.introduction);	
			checkaudio=2;
		}
		//mp.setVolume(10,10);
		mp.start();  
