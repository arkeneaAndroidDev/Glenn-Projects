    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.share_container:
                ...
                String share_massage = "Download The Healing White Light by Glenn Harrold.";
            ...
            case R.id.review_container:
                ...
                //i.setData(Uri.parse("amzn://apps/android?p=com.Arkenea.TheHealingWhiteLight"));
            ...
            case R.id.more_container:
                ...
                //String uri = String.format("amzn://apps/android?p=com.Arkenea.TheHealingWhiteLight+showAll=1");
