...
public class HomeActivity extends BaseActivity implements OnClickListener {
    LinearLayout audio_container, ebook_container, social_container, share_container,
            review_container, more_container, help_container,website_container;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.audio_container:
                Log.e("Home activity","go to audiotrackActivity");
            ...
            case R.id.share_container:
                ...
                String share_massage = "Download Develop Your Self Confidence by Glenn Harrold.";
            ...
            case R.id.review_container:
                ...
                i.setData(Uri.parse("amzn://apps/android?p=com.Arkenea.SelfConfidance"));
            ...
            case R.id.more_container:
                ...
                String uri = String.format("amzn://apps/android?p=com.Arkenea.SelfConfidance&showAll=1");
