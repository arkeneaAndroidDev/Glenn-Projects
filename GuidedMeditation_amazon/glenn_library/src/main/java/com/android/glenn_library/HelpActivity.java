    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        support_email.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mGooglePlay)
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Report a problem with "+getResources().getString(R.string.app_name)+" standalone Android app");
                    else
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Report a problem with "+getResources().getString(R.string.app_name)+" standalone Amazon app");
        ...
        Lp.width = (int) Math.round(width * 0.5);
        ...
        Lp2.width = (int) Math.round(width * 0.6);
